# Code from https://github.com/piergiaj/representation-flow-cvpr19/blob/master/rep_flow_layer.py
# From the paper "Representation Flow for Action Recognition" by AJ Piergiovanni and Michael S. Ryoo
